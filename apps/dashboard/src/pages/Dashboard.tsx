...
import { Users, FileText, ShoppingCart, TrendingUp, DollarSign } from 'lucide-react'

const stats = [
  { icon: Users, label: 'Total Users', value: '2,543', change: '+12%', color: 'blue' },
  { icon: FileText, label: 'Templates', value: '1,234', change: '+8%', color: 'green' },
  { icon: ShoppingCart, label: 'Orders', value: '567', change: '+23%', color: 'purple' },
  { icon: DollarSign, label: 'Revenue', value: '$12,345', change: '+18%', color: 'yellow' },
]
